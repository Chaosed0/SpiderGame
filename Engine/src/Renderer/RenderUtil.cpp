	...
	const void *userParam)
{
	...
	if (userParam != nullptr) {
		Renderer::DebugLogCallback* callback = (Renderer::DebugLogCallback*)userParam;
...
GLenum glDrawTypeFromMaterial(const Material& material)
{
	switch (material.drawType) {
	case MaterialDrawType_Lines:
		return GL_LINES;
		break;
	case MaterialDrawType_Triangles:
		return GL_TRIANGLES;
		break;
	}
}
